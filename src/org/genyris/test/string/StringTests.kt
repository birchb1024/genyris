...
class StringTests : TestCase() {
    ...
    private fun checkEval(exp: String?, expected: String?) {
        Assert.assertEquals(expected, interpreter!!.eval(exp))
    }

    @kotlin.Throws(GenyrisException::class)
    private fun checkEvalBad(exp: String?) {
        try {
    ...
    fun testStringSplit() {
        ...
        checkEval(
            "('http://www.genyris.org/path/index.html'(.split 'http://'))",
            "('' 'www.genyris.org/path/index.html')"
        )
    }
    ...
    fun testStringToInts() {
        ...
        checkEval(
            "('abcdefghijklmnopqrstuvwxyz'(.toInts 'ASCII'))",
    ...
    fun testStringFromJSON() {
        ...
        checkEval(
            "('{\"alpha\": 1, \"bravo\": NULL, \"charlie\" : \"C\" }'(.fromJSON))",
            "(dict (.alpha = 1) (.bravo = nil) (.charlie = 'C'))"
        )
        checkEval(
            "('{\"alpha\": { \"bravo\": NULL, \"charlie\" : \"C\" }}'(.fromJSON))",
            "(dict (.alpha = (dict (.bravo = nil) (.charlie = 'C'))))"
        )
    ...
    @kotlin.Throws(GenyrisException::class)
    fun testStringToIntsInternational() {
        ...
        checkEval(
            "('abcdefghijklmnopqrstuvwxyz'(.toInts 'UTF-16'))",
            "(254 255 0 97 0 98 0 99 0 100 0 101 0 102 0 103 0 104 0 105 0 106 0 107 0 108 0 109 0 110 0 111 0 112 0 113 0 114 0 115 0 116 0 117 0 118 0 119 0 120 0 121 0 122)"
        )
        checkEval(
            "('ABCDEFGHIJKLMNOPQRSTUVWXYZ'(.toInts 'ISO-8859-1'))",
            "(65 66 67 68 69 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90)"
        )
    ...
    fun testStringFromInts() {
        ...
        checkEval(
            "(String!fromInts 'ASCII' ^(97 98 99 100 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115 116 117 118 119 120 121 122))",
            "'abcdefghijklmnopqrstuvwxyz'"
        )
        checkEval(
            "(String!fromInts 'ASCII' ^(65 66 67 68 69 70 71 72 73 74 75 76 77 78 79 80 81 82 83 84 85 86 87 88 89 90))",
            "'ABCDEFGHIJKLMNOPQRSTUVWXYZ'"
        )
    ...
    @kotlin.Throws(GenyrisException::class)
    fun testStringSliceBase64() {
        checkEval(
            "(('TlRMTVNTUAABAAAAB7IIogcABwA1AAAADQANACgAAAAFASgKAAAAD1cwMDFFNEZGMDQ5M0JPQ0VBTklB'(.fromBase64))(.slice 0 6))",
            "'NTLMSS'"
        )
        checkEval(
            "(('TlRMTVNTUAABAAAAB7IIogcABwA1AAAADQANACgAAAAFASgKAAAAD1cwMDFFNEZGMDQ5M0JPQ0VBTklB'(.fromBase64))(.length))",
            "60"
        )
        checkEval(
            "(('TlRMTVNTUAABAAAAB7IIogcABwA1AAAADQANACgAAAAFASgKAAAAD1cwMDFFNEZGMDQ5M0JPQ0VBTklB'(.fromBase64))(.slice (- 59 6) 60))",
            "'OCEANIA'"
        )
    }
    ...
    fun testStringRegex() {
        ...
        checkEval(
            "('http://www.genyris.org/path/index.html'(.regex 'http://[^/]+/.*'))",
            "('http://www.genyris.org/path/index.html')"
        )
        checkEval(
            "('This order was placed for QT3000! OK?'(.regex '(.*)(\\\\d+)(.*)'))",
        ...
        checkEval(
            "('http://www.genyris.org:8080/path/index.html'(.regex '([a-z]+)://([^/]+):([0-9]+)(/.*)'))",
            "('http://www.genyris.org:8080/path/index.html' 'http' 'www.genyris.org' '8080' '/path/index.html')"
        )
        checkEval("('1212'(.regex '(\\\\d\\\\d)\\\\1'))", "('1212' '12')")

        checkEval(
            "('http://stackoverflow.com/questions/tagged/regex'(.regex '(?:http|ftp)://([^/]+)(/.*)'))",  // non-capturing group
    ...
    fun testBase64() {
        ...
        checkEval(
            "('zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz'(.toBase64))",
            "'enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6enp6eno='"
        )
    }
}
