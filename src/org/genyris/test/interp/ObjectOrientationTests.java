...
public class ObjectOrientationTests extends TestCase {
    ...
    public void testExcerciseEval() throws GenyrisException {
        ...
        checkEval("Standard-Class", "(dict (_classes : (<class Object (Thing) ()>)))");
        checkEval("(defvar 'Account (dict (_classes : (list Standard-Class)) (_print : (lambda () (cons $global _balance))) ))",
                "(dict (_print : <EagerProc: <org.genyris.interp.ClassicFunction>>) (_classes : ((dict (_classes : (<class Object (Thing) ()>))))))");
        ...
        checkEval("(defvar 'bb  (Account (_new 1000)))"
                ,"(dict (_balance : 1000) (_classes : ((dict (_new : <EagerProc: <org.genyris.interp.ClassicFunction>>) (_print : <EagerProc: <org.genyris.interp.ClassicFunction>>) (_classes : ((dict (_classes : (<class Object (Thing) ()>)))))))))");
    ...
    public void testInheritance() throws GenyrisException {
        ...
        checkEval("(defvar 'Base-1 " +
            "(dict " +
                ...
                , "(dict (_toString : \"Base-1 toString\") (_classes : ((dict (_classes : (<class Object (Thing) ()>))))))" );
        ...
        checkEval("(defvar 'Base-2 " +
            "(dict " +
                "(_classes : (cons Standard-Class nil)) " +
                "(_log : \"Base-2 log\"))) ",
                "(dict (_log : \"Base-2 log\") (_classes : ((dict (_classes : (<class Object (Thing) ()>))))))");
