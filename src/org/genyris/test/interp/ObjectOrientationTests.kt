...
class ObjectOrientationTests : TestCase() {
    ...
    fun testExcerciseEval() {
        ...
        checkEval(
            "(defvar ^Account (dict (.classes = (list Standard-Class)) (.print = (lambda () (cons global .balance))) ))",
